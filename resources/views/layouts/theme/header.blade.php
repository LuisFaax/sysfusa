            ...
            <div class="navbar-header">
                <ul class="nav navbar-nav flex-row ">
                    ...
                    <li class="nav-item"><a class="navbar-brand" href="index.html">
                        <i class="la la-legal red"></i>
                            <h3 class="brand-text">Sistema Fusa</h3>
                        </a></li>
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <span class="mr-1 user-name text-bold-700">
                                @guest LFax @else {{ Auth::user()->name }} @endguest
                            </span>
                            <span class="avatar avatar-online">
                                <img src="{{ asset('storage/' . Auth::user()->avatar) }}"  alt="avatar"><i></i>
                            </span></a>
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="#"><i class="ft-user"></i> Ver Perfil</a>
                                <div class="dropdown-divider"></div>
                                 <form id="form1" class="form-horizontal" method="POST" action="{{ route('logout') }}">
                                       {{ csrf_field() }} 
                                </form>
                                <a class="dropdown-item" onclick="document.getElementById('form1').submit();" href="javascript:void(0)"><i class="ft-power"></i> Cerrar Sesión</a>
                            </div>
                        </li>
                    </ul>
                </div>
